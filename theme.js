...
$(document).ready(function () {
 ...
 // *************************************** Orange studio ************************************************
if($('#loggedas').length){
$('#loggedas').after('<div id="slogan"><img class="img-responsive" src="/images/iam-digital-small.png"></div>');
}else{
$('#account').after('<div id="slogan"><img class="img-responsive" src="/images/iam-digital-small.png"></div>');
 ...
 // Show/hide Content Name at eMCM field.
  ...
  if ($('#issue_custom_field_values_20 option:selected').text() == 'Update Existing Content') {
  ...
  // Show/hide Content removal date field.
  $('#issue_custom_field_values_35').parent().css('display', 'none');
  if($('#issue_custom_field_values_34').is(':checked')) {
    $('#issue_custom_field_values_35').parent().css('display', 'block');
  }
  $('input[type=radio][id=issue_custom_field_values_34]').first().change(function() {
    $('#issue_custom_field_values_35').parent().css('display', 'block');
  });
  $("input[type=radio][name='issue[custom_field_values][34]']").change(function() {
    if (this.value == 0) {
      $('#issue_custom_field_values_35').parent().css('display', 'none');
    }
  });
